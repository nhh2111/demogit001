...
public class HashSetDemo {
    public static void main(String[] args) {
        ...
        HashSet<Students> studentsSet = new HashSet<>();
    ...
    private static void addStudent(HashSet<Students> studentsSet, Scanner scanner) {
    ...
    private static void updateStudent(HashSet<Students> studentsSet, Scanner scanner) {
    ...
    private static void deleteStudent(HashSet<Students> studentsSet, Scanner scanner) {
    ...
    private static void displayStudents(HashSet<Students> studentsSet){
