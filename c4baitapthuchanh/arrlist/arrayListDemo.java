...
public class arrayListDemo {
    ...
    private static void updateStudent(ArrayList<Students> studentsSet, Scanner scanner) {
    ...
    private static void deleteStudent(ArrayList<Students> studentsSet, Scanner scanner) {
